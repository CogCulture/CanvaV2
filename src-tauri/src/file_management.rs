...
fn resolve_thumbnail_cache_dir(app_handle: &crate::DummyAppHandle) -> std::result::Result<std::path::PathBuf, String> {
...
fn emit_thumbnail_cache_setup_error(app_handle: &crate::DummyAppHandle, path: &str, reason: &str) {
...
pub fn list_images_in_dir(path: String, app_handle: crate::DummyAppHandle) -> Result<Vec<ImageFile>, String> {
...
fn get_albums_path(app_handle: &crate::DummyAppHandle) -> Result<std::path::PathBuf, String> {
...
pub fn get_albums(app_handle: crate::DummyAppHandle) -> Result<Vec<AlbumItem>, String> {
...
pub fn save_albums(mut tree: Vec<AlbumItem>, app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
pub fn get_thumbnail_for_path(
    ...
    if let Ok(cache_dir) = get_thumb_cache_dir(&app_handle) {

        if let Some((thumbnail_data, _, _)) = generate_single_thumbnail_and_cache(
...
pub fn start_thumbnail_workers(app_handle: crate::DummyAppHandle) {
            ...
            loop {
                ...
                let path_to_process: String = {
                    ...
                    if processing.contains(&path) {
                        ...
                        let state = app_clone.state::<std::sync::Arc<crate::app_state::AppState>>();
...
pub fn add_to_thumbnail_queue(state: &AppState, count: usize, app_handle: &crate::DummyAppHandle) {
...
pub fn increment_thumbnail_progress(state: &AppState, app_handle: &crate::DummyAppHandle) {
...
pub fn rename_folder(path: String, new_name: String, app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
pub fn delete_folder(path: String, app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
pub fn save_metadata_and_update_thumbnail(
    ...
    thread::spawn(move || {
        ...
        let state = app_handle_clone.state::<std::sync::Arc<AppState>>();
...
pub fn load_metadata(path: String, app_handle: crate::DummyAppHandle) -> Result<ImageMetadata, String> {
...
fn get_presets_path(app_handle: &crate::DummyAppHandle) -> Result<std::path::PathBuf, String> {
...
pub fn load_presets(app_handle: crate::DummyAppHandle) -> Result<Vec<PresetItem>, String> {
...
pub fn save_presets(presets: Vec<PresetItem>, app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
fn get_internal_library_root_path(app_handle: &crate::DummyAppHandle) -> Result<std::path::PathBuf, String> {
...
pub fn get_or_create_internal_library_root(app_handle: crate::DummyAppHandle) -> Result<String, String> {

    let library_root = get_internal_library_root_path(&app_handle).map_err(|e| e.to_string())?;
...
pub fn clear_thumbnail_cache(app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
pub fn delete_files_from_disk(paths: Vec<String>, app_handle: crate::DummyAppHandle) -> Result<(), String> {
...
pub fn get_thumb_cache_dir(app_handle: &crate::DummyAppHandle) -> Result<std::path::PathBuf, String> {
