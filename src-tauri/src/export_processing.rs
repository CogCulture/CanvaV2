            ...
            let handle = tokio::task::spawn_blocking(move || {
                ...
                let result: Result<(), String> = (|| {
                    ...
                    let base_image = if is_current_edit {
                        ...
                        match get_full_image_for_processing(state.clone()) {
...
pub fn cancel_export(state: axum::extract::State<std::sync::Arc<AppState>>) -> Result<(), String> {
...
pub async fn estimate_export_sizes(
...

    {
        ...
        let lut = adjustments_clone["lutPath"]
            ...
            .and_then(|p| get_or_load_lut(state.clone(), p).ok());
