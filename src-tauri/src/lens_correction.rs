...
pub fn load_lensfun_db(app_handle: &crate::DummyAppHandle) -> LensDatabase {
...
pub fn get_lensfun_makers(state: axum::extract::State<std::sync::Arc<AppState>>) -> Result<Vec<String>, String> {
