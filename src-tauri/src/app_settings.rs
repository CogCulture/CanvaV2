...
pub fn get_settings_path(app_handle: &crate::DummyAppHandle) -> Result<std::path::PathBuf, String> {
...
pub fn load_settings(app_handle: crate::DummyAppHandle) -> Result<AppSettings, String> {
...
pub fn save_settings(settings: AppSettings, app_handle: crate::DummyAppHandle) -> Result<(), String> {
